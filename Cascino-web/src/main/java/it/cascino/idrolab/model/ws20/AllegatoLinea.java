...
@XmlRootElement(name = "allegato_linea")
public class AllegatoLinea {
	...
	public boolean equals(Object obj){
		...
		if(getClass() != obj.getClass())
			return false;
		AllegatoLinea other = (AllegatoLinea)obj;
	...
	public String toString(){
		return "AllegatoLinea [allegatoNome=" + allegatoNome + ", allegatoDescrizione=" + allegatoDescrizione + ", allegatoDimensione=" + allegatoDimensione + ", allegatoSicurezza=" + allegatoSicurezza + ", allegatoSiglatipo=" + allegatoSiglatipo + ", allegatoDestipo=" + allegatoDestipo + ", allegatoLink=" + allegatoLink + "]";
	}
