...
@XmlRootElement(name = "allegato_modello")
public class AllegatoModello {
	...
	public boolean equals(Object obj){
		...
		if(getClass() != obj.getClass())
			return false;
		AllegatoModello other = (AllegatoModello)obj;
	...
	public String toString(){
		return "AllegatoModello [allegatoNome=" + allegatoNome + ", allegatoDescrizione=" + allegatoDescrizione + ", allegatoDimensione=" + allegatoDimensione + ", allegatoSicurezza=" + allegatoSicurezza + ", allegatoSiglatipo=" + allegatoSiglatipo + ", allegatoDestipo=" + allegatoDestipo + ", allegatoLink=" + allegatoLink + "]";
	}
