...
--
-- Name: articoli_alternativi; Type: TABLE; Schema: cascino_schema; Owner: cascino_user_db; Tablespace: 
--
...
ALTER TABLE cascino_schema.articoli_alternativi OWNER TO cascino_user_db;

--
-- Name: articoli_alternativi_id_seq; Type: SEQUENCE; Schema: cascino_schema; Owner: cascino_user_db
--
...
ALTER TABLE cascino_schema.articoli_alternativi_id_seq OWNER TO cascino_user_db;

--
-- Name: articoli_alternativi_id_seq; Type: SEQUENCE OWNED BY; Schema: cascino_schema; Owner: cascino_user_db
--
...
--
-- Data for Name: articoli_alternativi; Type: TABLE DATA; Schema: cascino_schema; Owner: cascino_user_db
--



--
-- Name: articoli_alternativi_id_seq; Type: SEQUENCE SET; Schema: cascino_schema; Owner: cascino_user_db
--
...
--
-- Name: articoli_alternativi_articolo_articolo_componente_unqk; Type: CONSTRAINT; Schema: cascino_schema; Owner: cascino_user_db; Tablespace: 
--
...
--
-- Name: articoli_alternativi_prik; Type: CONSTRAINT; Schema: cascino_schema; Owner: cascino_user_db; Tablespace: 
--
...
--
-- Name: fki_articoli_alternativi_articolo_componente_fonk; Type: INDEX; Schema: cascino_schema; Owner: cascino_user_db; Tablespace: 
--
...
--
-- Name: fki_articoli_alternativi_articolo_fonk; Type: INDEX; Schema: cascino_schema; Owner: cascino_user_db; Tablespace: 
--
...
--
-- Name: updtime_articoli_alternativi_trg; Type: TRIGGER; Schema: cascino_schema; Owner: cascino_user_db
--
...
--
-- Name: articoli_alternativi_articolo_componente_fonk; Type: FK CONSTRAINT; Schema: cascino_schema; Owner: cascino_user_db
--
...
--
-- Name: articoli_alternativi_articolo_fonk; Type: FK CONSTRAINT; Schema: cascino_schema; Owner: cascino_user_db
--
