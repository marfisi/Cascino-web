...
--
-- Name: articoli_accessori; Type: TABLE; Schema: cascino_schema; Owner: postgres; Tablespace: 
--
...
ALTER TABLE cascino_schema.articoli_accessori OWNER TO postgres;

--
-- Name: articoli_accessori_id_seq; Type: SEQUENCE; Schema: cascino_schema; Owner: postgres
--
...
ALTER TABLE cascino_schema.articoli_accessori_id_seq OWNER TO postgres;

--
-- Name: articoli_accessori_id_seq; Type: SEQUENCE OWNED BY; Schema: cascino_schema; Owner: postgres
--
...
--
-- Data for Name: articoli_accessori; Type: TABLE DATA; Schema: cascino_schema; Owner: postgres
--



--
-- Name: articoli_accessori_id_seq; Type: SEQUENCE SET; Schema: cascino_schema; Owner: postgres
--
...
--
-- Name: articoli_accessori_articolo_articolo_componente_unqk; Type: CONSTRAINT; Schema: cascino_schema; Owner: postgres; Tablespace: 
--
...
--
-- Name: articoli_accessori_prik; Type: CONSTRAINT; Schema: cascino_schema; Owner: postgres; Tablespace: 
--
...
--
-- Name: fki_articoli_accessori_articolo_componente_fonk; Type: INDEX; Schema: cascino_schema; Owner: postgres; Tablespace: 
--
...
--
-- Name: fki_articoli_accessori_articolo_fonk; Type: INDEX; Schema: cascino_schema; Owner: postgres; Tablespace: 
--
...
--
-- Name: updtime_articoli_accessori_trg; Type: TRIGGER; Schema: cascino_schema; Owner: postgres
--
...
--
-- Name: articoli_accessori_articolo_componente_fonk; Type: FK CONSTRAINT; Schema: cascino_schema; Owner: postgres
--
...
--
-- Name: articoli_accessori_articolo_fonk; Type: FK CONSTRAINT; Schema: cascino_schema; Owner: postgres
--
