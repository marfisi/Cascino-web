...
--
-- Name: articoli_foto; Type: TABLE; Schema: cascino_schema; Owner: cascino_user_db; Tablespace: 
--
...
ALTER TABLE cascino_schema.articoli_foto OWNER TO cascino_user_db;

--
-- Name: articoli_foto_id_seq; Type: SEQUENCE; Schema: cascino_schema; Owner: cascino_user_db
--
...
ALTER TABLE cascino_schema.articoli_foto_id_seq OWNER TO cascino_user_db;

--
-- Name: articoli_foto_id_seq; Type: SEQUENCE OWNED BY; Schema: cascino_schema; Owner: cascino_user_db
--
...
--
-- Data for Name: articoli_foto; Type: TABLE DATA; Schema: cascino_schema; Owner: cascino_user_db
--



--
-- Name: articoli_foto_id_seq; Type: SEQUENCE SET; Schema: cascino_schema; Owner: cascino_user_db
--
...
--
-- Name: articoli_foto_prik; Type: CONSTRAINT; Schema: cascino_schema; Owner: cascino_user_db; Tablespace: 
--
...
--
-- Name: fki_articoli_foto_articolo_fonk; Type: INDEX; Schema: cascino_schema; Owner: cascino_user_db; Tablespace: 
--
...
--
-- Name: fki_articoli_foto_articolo_fornitore_fonk; Type: INDEX; Schema: cascino_schema; Owner: cascino_user_db; Tablespace: 
--
...
--
-- Name: fki_articoli_foto_foto_fonk; Type: INDEX; Schema: cascino_schema; Owner: cascino_user_db; Tablespace: 
--
...
--
-- Name: updtime_articoli_foto_trg; Type: TRIGGER; Schema: cascino_schema; Owner: cascino_user_db
--
...
--
-- Name: articoli_foto_articolo_fonk; Type: FK CONSTRAINT; Schema: cascino_schema; Owner: cascino_user_db
--
...
--
-- Name: articoli_foto_articolo_fornitore_fonk; Type: FK CONSTRAINT; Schema: cascino_schema; Owner: cascino_user_db
--
...
--
-- Name: articoli_foto_foto_fonk; Type: FK CONSTRAINT; Schema: cascino_schema; Owner: cascino_user_db
--
